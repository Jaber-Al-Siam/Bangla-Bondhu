package com.example.bangla_bondhu.model.gcptts;
...
import com.example.bangla_bondhu.R;
 ...
 * Reference:
 */
public class GCloudTTSActivity extends AppCompatActivity {
    ...
    private GCloudTTSViewModel mMainViewModel;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_g_cloud_tts_activiy);

        ButterKnife.bind(this);
        initViewValues();

        GoogleCloudTTS googleCloudTTS = GoogleCloudTTSFactory.create("AIzaSyBHObDQQEm9xxsyTLGj3prmvG45d-0C1WY");
        mMainViewModel = new GCloudTTSViewModel(getApplication(), googleCloudTTS);

        onLoading();

        Bundle bundle = getIntent().getExtras();
        if(bundle.getString("text")!= null) {
            mEditText.setText(bundle.getString("text"));
        }
    }
